  ...
  sections: [
    {
      ...
      body: (
        <p>That’s why we’ve designed this dashboard to explain what all the charts and spreadsheets mean. Our scientists have combed the data and created a system for understanding when its good, when it’s bad, and when it’s something in between.</p>
      )
    },
    {
      image: 'amoeba-mission@2x.png',
      title: 'We’re working to change the relationship with the water around us',
      body: (
        <p>We’re tracking water quality because we have a vision in which people that represent the full diversity of New York City are swimming in and around Manhattan safely, enjoying free and safe access to the river. We’re working on that vision everyday, and in the meantime, put design at the center of everything we do. Design is all around us and can be used to solve environmental problems, drive economic development, fuel innovation, teach kids, promote public health and help us understand things a little better, like this dashboard tries to do. Our project and programs recognize design’s ever-present impact on everybody.</p>
      ),
    ...
    },
    {
      ...
      title: 'Citizens should be given the chance to help make their cities better.',
      body: (
        <p>+ POOL is made up of an incredible group of people that are all working together to push for access to our rivers for swimming, and helping change our relationship with the water around us. Our friends send ideas, participate in programs, lend expertise, volunteer, support fundraising, and advocate for + POOL and the ideas generated by it.</p>
      ),
